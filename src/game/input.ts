 ...
 * That is the whole control scheme. Keyboard is wired up too, purely so the
 * game can be developed on a laptop.
 */
export class InputController {
  ...
  consume(): Input {
    const out: Input = { jumpPressed: this.pendingJump, jumpHeld: this.held };
